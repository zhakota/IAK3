...
write.csv(df_read_excel, "data/interim/df_read_excel.csv")
write.csv(df, "data/interim/df.csv")
write.csv(df1, "data/interim/df1.csv")
write.csv(df1_no_date, "data/interim/df1_no_date.csv")
write.csv(df1_no_na_col, "data/interim/df1_no_na_col.csv")
