...
df <- df_en %>% 
  select(-c("Identifier", "BG_HRHY_R", "RELAKEY", "AK_MOD", "Prosthesis_Name", "AK_PROZ", "THG_NR", "LQ_LQ", "REOP?":"REOP_EING5"))
...
write.csv(df1, "data/interim/df1.csv", row.names = FALSE) # Назначены классы признакам (фактор, дата, количественная)
